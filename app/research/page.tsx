            ...
            {researchData.map((d) => (
              <div key={d.title} className="md max-w-[544px] p-4 md:w-1/2">
                <a
                  ...
                  className="group flex h-full flex-col overflow-hidden rounded-md border-2 border-gray-200 border-opacity-60 transition-colors hover:border-primary-400 dark:border-gray-700 dark:hover:border-primary-500"
                >
                  {d.imgSrc && (
                    <Image
                      alt={d.title}
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <span className="text-base font-medium leading-6 text-primary-500 group-hover:text-primary-600 dark:group-hover:text-primary-400">
                      Read more &rarr;
                    </span>
                  </div>
                </a>
